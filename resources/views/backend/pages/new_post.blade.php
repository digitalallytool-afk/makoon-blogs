...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" id="article-form">
                @csrf
                            ...
                            <div class="card-body p-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control form-control-lg border-0 bg-light-subtle shadow-none font-20"
                                           id="post-title" name="title" value="{{ old('title') }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" id="post-content" name="content" required>{{ old('content') }}</textarea>
                                </div>
                                ...
                                <div class="mb-0">
                                    ...
                                    <textarea class="form-control border-0 bg-light" id="post-excerpt" name="excerpt" rows="3"
                                              placeholder="Write a brief article summary...">{{ old('excerpt') }}</textarea>
                        ...
                        <div class="card radius-10 border-0 shadow-sm mb-0">
                            ...
                            <div class="card-body pt-1">
                                ...
                                <div class="form-check form-switch mb-3" style="padding-left: 2.5em;">
                                    <input class="form-check-input" type="checkbox" id="post-is-selected" name="is_selected" value="1">
                                ...
                                <div class="form-check form-switch mb-3" style="padding-left: 2.5em;">
                                    <input class="form-check-input" type="checkbox" id="post-is-trending" name="is_trending" value="1">
                                ...
                                <div class="mb-0">
                                    ...
                                    <input type="number" class="form-control font-13 @error('view_count') is-invalid @enderror" id="post-view-count" name="view_count" value="{{ old('view_count', 0) }}" min="0">
                                    @error('view_count')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    <small class="text-muted d-block font-11 mt-1">Specify initial view count for this blog.</small>
                                </div>
                            </div>
