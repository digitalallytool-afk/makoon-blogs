                            ...
                            <div class="card-body pt-2">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div style="border:1px solid #e0e0e0;border-radius:8px;padding:10px 12px;background:#fff;">
                                        <div id="serp-url" style="font-size:11px;color:#1a7f37;margin-bottom:2px;word-break:break-all;">makoons.com › stories › ...</div>
                                        <div id="serp-title" style="font-size:14px;color:#1a0dab;font-weight:600;line-height:1.3;margin-bottom:3px;">Your story title will appear here</div>
                        ...
                        <div class="card radius-10 border-0 shadow-sm mb-0">
                            ...
                            <div class="card-body pt-1">
                                ...
                                <div class="mb-0">
                                    ...
                                    <input type="number" class="form-control font-13 @error('view_count') is-invalid @enderror" id="story-view-count" name="view_count" value="{{ old('view_count', 0) }}" min="0">
                                    @error('view_count')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    <small class="text-muted d-block font-11 mt-1">Specify initial view count for this story.</small>
                                </div>
                            </div>
                            ...
                            <div class="card-body pt-1">
                                ...
                                <select class="form-select" id="story-category" name="story_category_id" required>
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ old('story_category_id') == $category->id ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
