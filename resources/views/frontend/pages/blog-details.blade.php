...
@section('content')
    @if (isset($isPreview) && $isPreview)
        <div
            style="background-color: #fff3cd; color: #664d03; padding: 12px; text-align: center; font-weight: bold; border-bottom: 1px solid #ffe69c; position: sticky; top: 0; z-index: 1050; font-family: 'Inter', sans-serif;">
                ...
                <div class="article-topline">
                    <div class="detail-byline article-author-block">
                        <a class="article-author-link"
                            ...
                            @else
                                <img src="data:image/svg+xml;charset=UTF-8,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20viewBox%3D%220%200%20120%20120%22%3E%0A%20%20%3Crect%20width%3D%22120%22%20height%3D%22120%22%20rx%3D%2260%22%20fill%3D%22%23f9efe5%22/%3E%0A%20%20%3Ccircle%20cx%3D%2260%22%20cy%3D%2252%22%20r%3D%2228%22%20fill%3D%22%23b9794e%22/%3E%0A%20%20%3Cpath%20d%3D%22M31%2053c2-24%2016-35%2031-35%2018%200%2030%2014%2029%2036-11-11-21-11-32-10-12%201-20-2-28%209z%22%20fill%3D%22%232e1a12%22/%3E%0A%20%20%3Cpath%20d%3D%22M24%20114c6-24%2021-36%2036-36s30%2012%2036%2036%22%20fill%3D%22%23f5b42b%22/%3E%0A%20%20%3Cpath%20d%3D%22M38%2084c8%208%2036%208%2044%200%22%20stroke%3D%22%23fff%22%20stroke-width%3D%225%22%20stroke-linecap%3D%22round%22%20fill%3D%22none%22/%3E%0A%20%20%3Ccircle%20cx%3D%2250%22%20cy%3D%2255%22%20r%3D%223%22%20fill%3D%22%232e1a12%22/%3E%0A%20%20%3Ccircle%20cx%3D%2270%22%20cy%3D%2255%22%20r%3D%223%22%20fill%3D%22%232e1a12%22/%3E%0A%20%20%3Cpath%20d%3D%22M52%2066c5%204%2011%204%2016%200%22%20stroke%3D%22%232e1a12%22%20stroke-width%3D%223%22%20stroke-linecap%3D%22round%22%20fill%3D%22none%22/%3E%0A%3C/svg%3E"
                                    alt="">
                            @endif
                            <span>
                        ...
                        <span class="article-meta-line">
                            ...
                            @if ($post->category)
                                ...
                                @endphp
                                <span><a
                                        href="{{ route('category.show', $displayCategory->slug) }}">{{ $displayCategory->name }}</a></span>
                            @endif
                            <span class="detail-view-count" aria-label="{{ $post->view_count }} views">
                                ...
                                {{ $post->view_count >= 1000 ? number_format($post->view_count / 1000, 1) . 'k' : $post->view_count }}
                                views
                            </span>
                        </span>
                    </div>
                    ...
                    <div class="socialShare" aria-label="Share this blog post">
                        <a target="_blank"
                            ...
                            class="socialShare__link" data-social-share="Facebook" aria-label="Share to Facebook">
                        ...
                        <a target="_blank"
                            ...
                            class="socialShare__link" data-social-share="Twitter" aria-label="Share to Twitter">
                            <span class="icon"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <a target="_blank"
                            href="http://www.linkedin.com/shareArticle?mini=true&url={{ urlencode(request()->fullUrl()) }}"
                            class="socialShare__link" data-social-share="LinkedIn" aria-label="Share on LinkedIn">
                            <span class="icon"><svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M0 2.3391C0 1.04725 1.04653 0 2.3391 0H25.6609C26.9527 0 28 1.04653 28 2.3391V25.6609C28 26.9527 26.9535 28 25.6609 28H2.3391C1.04725 28 0 26.9535 0 25.6609V2.3391ZM11.0833 10.675H14.875V12.5802C15.4216 11.4847 16.8222 10.5 18.9263 10.5C22.9594 10.5 23.9167 12.6805 23.9167 16.6816V24.0917H19.8333V17.5928C19.8333 15.3143 19.2868 14.0292 17.8967 14.0292C15.9688 14.0292 15.1667 15.4146 15.1667 17.5928V24.0917H11.0833V10.675ZM4.08333 23.9167H8.16667V10.5H4.08333V23.9167ZM8.75 6.125C8.75 7.57458 7.57458 8.75 6.125 8.75C4.67542 8.75 3.5 7.57458 3.5 6.125C3.5 4.67542 4.67542 3.5 6.125 3.5C7.57458 3.5 8.75 4.67542 8.75 6.125Z"
                                        fill="currentColor"></path>
                                </svg></span>
                        </a>
                        <a target="_blank"
                            href="https://www.pinterest.com/pin/create/button/?url={{ urlencode(request()->fullUrl()) }}&description={{ urlencode($post->title) }}"
                            class="socialShare__link" data-social-share="Pinterest" aria-label="Share to Pinterest">
                            <span class="icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 999.9 999.9"
                                    width="28" height="28">
                                    <path
                        ...
                        <button class="socialShare__link socialShare__clip" aria-label="Copy Link" data-copy-link>
                            <span class="socialShare__copyChain"><span class="icon"><svg width="28" height="28"
                            ...
                            <span class="socialShare__copyCheck"><span class="icon"><svg width="28" height="28"
            ...
            <div class="container-xl article-clean-layout">
                <aside class="article-keyword-sidebar article-detail-side" aria-label="Blog sidebar">
                    <div class="trending-sidebar detail-topic-panel" aria-label="Explore blogs by topic">
                        ...
                        <div class="detail-topic-articles" aria-label="Trending blogs">
                            @foreach ($trendingPosts as $rPost)
                                @php
                                    $rViewsStr =
                                        $rPost->view_count >= 1000
                                            ? number_format($rPost->view_count / 1000, 1) . 'k'
                                            : $rPost->view_count;
                                @endphp
                        ...
                        <form class="trending-subscribe detail-topic-subscribe" action="#" method="POST">
                            ...
                            <div>
                                <input id="detail-topic-email" name="email" type="email" placeholder="Email address"
                                    required>
                    ...
                    <div class="article-category-card" aria-label="Blog categories">
                        ...
                        @foreach ($homeCategories as $hCat)
                            <a href="{{ route('category.show', $hCat->slug) }}"
                                class="{{ $hCat->id === $post->category_id ? 'active' : '' }}">
                                <span>{{ $hCat->name }}</span>
                ...
                <article class="article-content clean-article" data-article-content>
                    @if ($post->featured_image)
                        <div class="detail-featured-image-wrapper"
                            style="margin-bottom: 2rem; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
            ...
            <div class="container-xl related-clean-inner">
                ...
                <div class="related-article-grid">
                    @foreach ($trendingPosts as $index => $tPost)
                        @php
                            $isUrl =
                                $tPost->featured_image &&
                                \Illuminate\Support\Str::contains($tPost->featured_image, '/');
                            $bgStyle = $isUrl
                                ? 'style="background-image: url(' . asset($tPost->featured_image) . ');"'
                                : '';
                            $tViewsStr =
                                $tPost->view_count >= 1000
                                    ? number_format($tPost->view_count / 1000, 1) . 'k'
                                    : $tPost->view_count;
                            $mediaClasses = ['related-one', 'related-two', 'related-three', 'related-four'];
                            $mediaClass = $isUrl ? '' : $mediaClasses[$index % 4] ?? 'related-one';
                        @endphp
                        <article class="related-article-card">
                            <a class="related-article-media {{ $mediaClass }}" {!! $bgStyle !!}
                                href="{{ route('blog.show', $tPost->slug) }}"
                                aria-label="Read {{ $tPost->title }} blog post"></a>
                            <div class="related-article-copy">
                                <span>
                                    @if ($tPost->category)
                                        <a
                                            href="{{ route('category.show', $tPost->category->slug) }}">{{ $tPost->category->name }}</a>
                                        ·
                                    @endif
                                    5 min read
                                </span>
                                ...
                                <div class="card-bottom-meta">
                                    <span class="view-count" aria-label="{{ $tViewsStr }} views"><svg
                                        ...
                                        </svg>{{ $tViewsStr }} views</span>
                                    <a class="post-author"
                                        href="{{ route('author') }}?author={{ Str::slug($tPost->author->name ?? '') }}"
                                        aria-label="View blogs by {{ $tPost->author->name ?? '' }}">
                                        @if ($tPost->author && $tPost->author->image)
                                            <img src="{{ asset($tPost->author->image) }}"
                                                alt="{{ $tPost->author->name }}">
                                        @endif
