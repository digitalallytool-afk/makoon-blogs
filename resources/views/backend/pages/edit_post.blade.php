                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control border-0 bg-light-subtle shadow-none font-14"
                                           id="post-slug" name="slug" value="{{ old('slug', $post->slug) }}"
                            ...
                            <div class="card-body pt-2">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div style="border:1px solid #e0e0e0;border-radius:8px;padding:10px 12px;background:#fff;">
                                        ...
                                        <div id="serp-title" style="font-size:14px;color:#1a0dab;font-weight:600;line-height:1.3;margin-bottom:3px;">{{ $post->meta_title ?: $post->title }}</div>
                                        <div id="serp-desc" style="font-size:12px;color:#4d5156;line-height:1.5;">{{ $post->meta_description ?: 'Your meta description will appear here.' }}</div>
                                    </div>
                                </div>
